...
customElements.define('action-handler-lcars', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-lcars')) {
    return body.querySelector('action-handler-lcars') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-lcars');
